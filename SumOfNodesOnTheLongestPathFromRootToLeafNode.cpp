...
public:
    pair<int, int> height(Node* root){
        ...
        //initially sum will only contain the data of the current node
        int sum=root->data;
        
        //if the heights of left and right subtrees are equal
        if(leftHeight.first==rightHeight.first){
            //higher sum will be considered
            if(leftHeight.second>rightHeight.second){
